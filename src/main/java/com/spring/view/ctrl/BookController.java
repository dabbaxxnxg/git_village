...
public class BookController {
   ...
   public String join(BookVO vo, BookDAO bookDAO, HttpSession session) throws IOException {
      ...
      if(!uploadFile.isEmpty()) {
         ...
         vo.setImg(fileName);
         uploadFile.transferTo(new File("C:\\Users\\dek06\\OneDrive\\문서\\workspace_java\\VillageBook_FINAL\\src\\main\\webapp\\img\\book\\" + fileName));
         //★ 각자 저장된 workspace의 VillageBook 경로 지정하면 프로젝트 내의 img/book에 저장됨
      }
