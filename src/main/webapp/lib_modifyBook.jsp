         ...
         <tr>
          ...
          <tr><th>업로드</th>
            ...
            <input type="file" id="upload" name="uploadFile"/>
            	<div id="wrapper" style=" display:inline-block; margin:10px;">
            	<!-- 기존 그림  -->
            	<div class="saved_img" style="float:left" ><img src="img/book/${book.img }"  alt="기존 책 이미지썸네일" style="height:300px;"/></div>
            	<div style="font-size:10px; float:left; padding: 150px 0 0 0;">&ensp;▶▶▶&ensp;</div>
               <!--  수정할 그림 -->
            <div class="select_img" style="float:left" >
            <img src="img/book/insertIMG.png"  alt="수정할 책 이미지썸네일" style="height:300px;"/></div></div> 
            <!-- Project Explorer에서 img/book/ refresh 안하면 그림 안뜬다!!!!!!!!~~~~~ -->
            <script>
