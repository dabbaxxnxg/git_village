...
Insert into BOOK values (9791190305679,'1일 1페이지, 세상에서 가장 짧은 교양 수업 365','데이비드 S. 키더','위즈덤하우스',to_date('2019-10-30','RR/MM/DD'),'인문', '365.jpg');
Insert into BOOK values (9788983711892,'코스모스 특별판','칼 세이건','사이언스북스',to_date('06/12/20','RR/MM/DD'),'과학', 'cosmos.jpg');
Insert into BOOK values (9788946421158,'스스로 행복하라','법정 저','샘터 ',to_date('2020-01-06','RR/MM/DD'),'문학', 'happy_yourself.jpg');
Insert into BOOK values (9788986022100,'식물의 책 - 식물세밀화가 이소영의 도시식물 이야기 ','이소영','책읽는수요일',to_date('2019-10-30','RR/MM/DD'),'과학', 'botanic_img.jpg');
Insert into BOOK values (9791155424353,'바이러스 쇼크 - 인류 재앙의 실체, 알아야 살아남는다','최강석 ','매일경제신문사',to_date('2020-03-01','RR/MM/DD'),'과학', 'virusshock.jpg');
Insert into BOOK values (9788952751546,'더 위험한 과학책 ','랜들 먼로','시공사',to_date('2020-01-20','RR/MM/DD'),'과학', 'dangerscience.jpg');
Insert into BOOK values (9791186900864,'재밌어서 밤새 읽는 해부학 이야기','사카이 다츠오','더숲',to_date('2019-05-20','RR/MM/DD'),'과학', 'anatomy.jpg');
Insert into BOOK values (9788997186884,'달로 가는 길 - 한 우주비행사의 이야기','마이클 콜린스 ','사월의 책',to_date('2019-07-20','RR/MM/DD'),'과학', 'gotomoon.jpg');
Insert into BOOK values (9791196250515,'저도 과학은 어렵습니다만','이정모','바틀비',to_date('2018-01-05','RR/MM/DD'),'과학', 'hardscience.jpg');
Insert into BOOK values (9788995677230,'꿈꾸는 기계의 진화','로돌포 R. 이나스','북센스',to_date('2019-06-20','RR/MM/DD'),'과학', 'machineEvolution.jpg');
Insert into BOOK values (9788970445137,'뉴턴의 법칙에서 아인슈타인의 상대론까지','팡리지','전파과학사',to_date('1991-02-01','RR/MM/DD'),'과학', 'newtontoeinstein.jpg');
Insert into BOOK values (9791187150640,'미술관에 간 물리학자 - 명화에서 찾은 물리학의 발견 ','서민아','어바웃어북',to_date('2020-02-07','RR/MM/DD'),'과학', 'physicalandart.jpg');
Insert into BOOK values (9791189932473,'이해하는 미적분 수업','데이비드 애치슨','바다출판사',to_date('2020-01-31','RR/MM/DD'),'과학', 'calculusstory.jpg');
Insert into BOOK values (9788995408407,'지구의 딸 지구시인 레이첼 카슨','김재희','이유책',to_date('03/07/03','RR/MM/DD'),'과학', 'rachelcarson.jpg');
Insert into BOOK values (9788958073123,'과학과 종교는 적인가 동지인가','로널드 L. 넘버스','뜨인돌',to_date('10/07/05','RR/MM/DD'),'과학', 'enemyfriend.jpg');
Insert into BOOK values (9788991373013,'내몸안의 주치의 면역','하가와라 기요후미','전나무숲',to_date('06/01/15','RR/MM/DD'),'과학', 'immune.jpg');
Insert into BOOK values (9791185104577,'프루프 - 술의 과학','아담 로저스','Mid(엠아이디)',to_date('2015-12-21','RR/MM/DD'),'과학','scienceofbooze.jpg');
Insert into BOOK values (9788965703112,'모든 순간의 물리학','카를로 로벨리','쌤앤파커스',to_date('2016-02-26','RR/MM/DD'),'과학', 'alltimephysics.jpg');
Insert into BOOK values (9791195568758,'부분과 전체','베르너 하이젠베르크','서커스',to_date('2016-08-20','RR/MM/DD'),'과학', 'partandall.jpg');
Insert into BOOK values (9788959090532,'원더풀 사이언스 - 아름다운 기초과학 산책 ','나탈리 앤지어 ','지호',to_date('10/01/18','RR/MM/DD'),'과학', 'wonderfulscience.jpg');
Insert into BOOK values (9788901147093,'진화심리학 - 마음과 행동을 탐구하는 새로운 과학','데이비드 M. 버스','웅진지식하우스',to_date('12/06/13','RR/MM/DD'),'과학', 'evolutionpsychology.jpg');
Insert into BOOK values (9788955618013,'다윈의 식탁','장대익','바다출판사',to_date('2015-11-05','RR/MM/DD'),'과학', 'dawinstable.jpg');
Insert into BOOK values (9791186560785,'수학이 필요한 순간 - 인간은 얼마나 깊게 생각할 수 있는가','김민형 ','인플루엔셜(주)',to_date('2018-08-03','RR/MM/DD'),'과학','mathneed.jpg');
Insert into BOOK values (9788954641630,'쇼코의 미소','최은영','문학동네',to_date('2019-06-20','RR/MM/DD'),'문학', 'smilesyoco.jpg');
Insert into BOOK values (9788936434267,'아몬드','손원평','창비 ',to_date('2017-03-31','RR/MM/DD'),' 문학', 'almond.jpg');
Insert into BOOK values (9788937461033,'인간실격','다자이 오사무','민음사',to_date('2014-4-15','RR/MM/DD'),' 문학', 'failhuman.jpg');
Insert into BOOK values (9788986836240,'왜 나는 너를 사랑하는가','알랭 드 보통','청미래',to_date('2013-01-15','RR/MM/DD'),' 문학', 'whyloveu.jpg');
Insert into BOOK values (9788972756194,'나미야 잡화점의 기적','히가시노 게이고','현대문학',to_date('12/12/19','RR/MM/DD'),' 문학', 'luckystore.jpg');
Insert into BOOK values (9788932023151,'비행운','김애란','문학과지성사',to_date('12/07/19','RR/MM/DD'),' 문학', 'flyship.jpg');
Insert into BOOK values (9791190090018,'우리가 빛의 속도로 갈 수 없다면','김초엽','허블',to_date('2019-06-24','RR/MM/DD'),' 문학', 'didntgolightfast.jpg');
Insert into BOOK values (9788988027400,'죽은 시인의 사회','N.H.클라인바움','서교출판사',to_date('04/03/30','RR/MM/DD'),' 문학', 'deadpoets.jpg');
Insert into BOOK values (9791130605210,'오베라는 남자','프레드릭 배크만','다산책방',to_date('2015-05-20','RR/MM/DD'),' 문학', 'oveman.jpg');
Insert into BOOK values (9788936437541,'디디의 우산','황정은','창비',to_date('2019-01-20','RR/MM/DD'),' 문학', 'ddumbrella.jpg');
Insert into BOOK values (9791190234023,'파인드 미','안드레 애치먼','잔',to_date('2019-12-16','RR/MM/DD'),' 문학', 'findme.jpg');
Insert into BOOK values (9791159039690,'어린왕자','생텍쥐페리','더스토리',to_date('2018-09-10','RR/MM/DD'),' 문학', 'littleprince.jpg');
Insert into BOOK values (9788936456085,'완득이','김기령','창비',to_date('2014-03-17','RR/MM/DD'),' 문학', 'wandeok.jpg');
Insert into BOOK values (9791190492249,'사랑 없는 세계','미우라 시온','은행나무',to_date('2020-01-29','RR/MM/DD'),' 문학', 'noloveworld.jpg');
Insert into BOOK values (9788937441943,'단순한 진심','조해진','믿음사',to_date('2019-07-05','RR/MM/DD'),' 문학', 'simplemind.jpg');
Insert into BOOK values (9788954640756,'너무 한낮의 연애','김금희','문학동네',to_date('2016-05-31','RR/MM/DD'),' 문학', 'toofavorlove.jpg');
Insert into BOOK values (9788936437381,'안녕 주정뱅이','권여선','창비',to_date('2016-05-16','RR/MM/DD'),' 문학','helloalcholic.jpg');
Insert into BOOK values (9788973814725,'멋진 신세계','올더스 헉슬리','소담출판사',to_date('2015-06-12','RR/MM/DD'),' 문학', 'bravenewworld.jpg');
Insert into BOOK values (9788998274931,'봉제인형 살인사건','다니엘 콜','북플라자',to_date('2019-10-20','RR/MM/DD'),' 문학', 'dollsuicide.jpg');
Insert into BOOK values (9791196076061,'기생충 각본집 & 스토리보드북 세트 - 전 2권','봉준호','플레인',to_date('2019-10-21','RR/MM/DD'),'예술', 'parasite.jpg');
Insert into BOOK values (9788925568171,'작은 아씨들 무비 아트북','지나 매킨타이어','알에이치코리아(RHK)',to_date('2020-02-12','RR/MM/DD'),'예술', 'littlewomen.jpg');
Insert into BOOK values (9788968331862,'방구석 미술관(아티스트 하우스 에디션)','조원재','블랙피쉬',to_date('2018-08-03','RR/MM/DD'),'예술','roomgallery.jpg');
Insert into BOOK values (9788988105726,'타인의 고통','수전 손택 ','이후',to_date('04/01/07','RR/MM/DD'),'예술', 'otherspain.jpg');
Insert into BOOK values (9788931588507,'김락희의 인체 드로잉','김락희','성안당',to_date('2019-11-27','RR/MM/DD'),'예술', 'bodydrawing.jpg');
Insert into BOOK values (9788932320250,'벨 에포크, 아름다운 시대','메리 매콜리프 ','현암사',to_date('2020-01-15','RR/MM/DD'),'예술', 'beautifulworld.jpg');
Insert into BOOK values (9791155812587,'총보다 강한 실','카시아 세인트 클레어 ','월북',to_date('2020-02-10','RR/MM/DD'),'예술', 'strongerthread.jpg');
Insert into BOOK values (9791190030281,'예술적 상상력','오종우','어크로스',to_date('2019-12-31','RR/MM/DD'),'예술', 'artisticimagine.jpg');
Insert into BOOK values (9788932036052,'매체의 역사 읽기','안드레아스 뵌,안드레아스 자이들러','문학과지성사',to_date('2020-01-30','RR/MM/DD'),'예술', 'mediengeschichte.jpg');
Insert into BOOK values (9788986377453,'아티스트 웨이','줄리아 카메론','경당',to_date('12/05/10','RR/MM/DD'),'예술', 'artistsway.jpg');
Insert into BOOK values (9788932320267,'새로운 세기의 예술가들','메리 매콜리프','현암사',to_date('2020-01-15','RR/MM/DD'),'예술', 'newcenturyartists.jpg');
Insert into BOOK values (9788932320274,'파리는 언제나 축제','메리 매콜리프','현암사',to_date('2020-01-15','RR/MM/DD'),'예술', 'alwaysfestivalparis.jpg');
Insert into BOOK values (9791155811566,'컬러의 말 : 모든 색에는 이름이 있다','카시아 세인트 클레어','윌북',to_date('2018-06-10','RR/MM/DD'),'예술', 'alwaysfestivalparis.jpg');
Insert into BOOK values (9788950980221,'레오나르도 다빈치','월터 아이작슨','arte(아르테)',to_date('2019-03-28','RR/MM/DD'),'예술', 'leonardodavinci.jpg');
Insert into BOOK values (9791196517106,'건반 위의 철학자','프랑수아 누델만','시간의흐름',to_date('2018-11-30','RR/MM/DD'),'예술', 'toucherofphilosophy.jpg');
Insert into BOOK values (9788954650892,'알랭 드 보통의 영혼의 미술관 (보급판)','알랭 드 보통,존 암스트롱','문학동네',to_date('2018-07-10','RR/MM/DD'),'예술', 'soulgallery.jpg');
Insert into BOOK values (9791190292023,'감정화하는 사회','오쓰카 에이지','리시올',to_date('2020-01-10','RR/MM/DD'),'예술', 'soulgallery.jpg');
Insert into BOOK values (9788992607148,'만화의 이해','스콧 맥클라우드','비즈앤비즈',to_date('08/07/01','RR/MM/DD'),'예술', 'cartoon.jpg');
Insert into BOOK values (9791190266017,'그림 쏙 세계사','릴리스','지식서재',to_date('2020-02-24','RR/MM/DD'),'예술', 'picinworldhistory.jpg');
Insert into BOOK values (9788965642473,'색체 속을 걷는 사람','조르주 디디 위베르만','현실문화A',to_date('2019-12-16','RR/MM/DD'),'예술', 'walkingcolor.jpg');
Insert into BOOK values (9791195739585,'서브컬처계를 여행하는 히지하이커를 위한 가이드','손지상','워크라이프',to_date('2020-01-20','RR/MM/DD'),'예술', 'subculture.jpg');
Insert into BOOK values (9788965133520,'유시민의 글쓰기 특강 - 유시민의 30년 베스트셀러 영업기밀','유시민','생각의길',to_date('2015-04-10','RR/MM/DD'),'인문', 'yoosiminswritingclass.jpg');
Insert into BOOK values (9791185600031,'내가 사는 세상 내가 하는 인문학 - 플라톤에서 니체로','문성준','새잎',to_date('2015-10-05','RR/MM/DD'),'인문', 'myworldmyhumanity.jpg');
Insert into BOOK values (9791159016646,'세계로 떠나는 인문학 - 인문학자 11인의 철학.문화.역사 이야기','권영우,김원명','한국외국어대학교출판부 지식출판원(HUINE)',to_date('2020-02-28','RR/MM/DD'),'인문', 'humanitytoworld.jpg');
Insert into BOOK values (9788934972464,'사피엔스','유발 하라리','김영사',to_date('2015-11-23','RR/MM/DD'),'인문', 'sapiens.jpg');
Insert into BOOK values (9791190313193,'지적 대화를 위한 넓고 얕은 지식 2','채사장','웨일북',to_date('2020-02-01','RR/MM/DD'),'인문', 'widelowknowlege.jpg');
Insert into BOOK values (9788954637756,'개인주의자 선언','문유석','문학동네',to_date('2015-09-23','RR/MM/DD'),'인문', 'individualist.jpg');
Insert into BOOK values (9788971996676,'담론','신영복','돌베개',to_date('2015-04-20','RR/MM/DD'),'인문', 'discussion.jpg');
Insert into BOOK values (9791160402971,'출근길의 주문','이다혜','한겨레출판',to_date('2019-09-30','RR/MM/DD'),'인문', 'gotoworkandorder.jpg');
Insert into BOOK values (9788962622508,'떨림과 울림','김상욱','동아시아',to_date('2018-11-07','RR/MM/DD'),'인문', 'chillandecho.jpg');
Insert into BOOK values (9788934977841,'호모 데우스','유발 하라리','김영사',to_date('2017-05-15','RR/MM/DD'),'인문', 'homodeus.jpg');
Insert into BOOK values (9788965962205,'라틴어 수업','한동일','흐름출판',to_date('2017-06-30','RR/MM/DD'),'인문', 'latinclass.jpg');
Insert into BOOK values (9788956055466,'책은 도끼다','박웅현','북하우스',to_date('11/10/10','RR/MM/DD'),'인문', 'bookax.jpg');
Insert into BOOK values (9788934926184,'만들어진 신','리처드 도킨스','김영사',to_date('07/07/20','RR/MM/DD'),'인문', 'goddelusion.jpg');
Insert into BOOK values (9791186900963,'지적이고 과학적인 음주탐구생활 - 술에 관한 깊고 넓은 인문학 강의 ','허원','더숲',to_date('2019-08-23','RR/MM/DD'),'인문', 'scientificalchollife.jpg');
Insert into BOOK values (9788971390849,'인간이 그리는 무늬','최진석','소나무',to_date('2013-05-06','RR/MM/DD'),'인문', 'drawingpatternbyhuman.jpg');
Insert into BOOK values (9788984314238,'나는 왜 쓰는가','조지 오웰','한겨레출판',to_date('10/09/15','RR/MM/DD'),'인문', 'whyiwriting.jpg');
Insert into BOOK values (9788979661682,'인간의 사고를 어떻게 이해할 것인가?','예발트 일리옌코프','책갈피',to_date('2019-11-27','RR/MM/DD'),'인문', 'howunderstandthought.jpg');
Insert into BOOK values (9788946044807,'영화, 사회복지를 만나다','김민아','한울아카데미',to_date('11/08/19','RR/MM/DD'),'사회과학', 'moviemetwelfare.jpg');
Insert into BOOK values (9788955920123,'사회와 건축공간','최윤경','스페이스타임',to_date('12/04/05','RR/MM/DD'),'사회과학', 'societyandspace.jpg');
