	...
	<table>
		<tr>
			<td colspan="2" >
				...
				<img src="img/book/<%=rs.getString("IMG") %>" alt="기본이미지" style="height:300px; margin:10px;"/>
				<% } else{ %>
				<img src="img/book/NULL.JPG" alt="책이미지" style="height:300px; margin:10px;"/>
				<%} %>
			</td>
		</tr>
		<tr>
			<td width="150" height="23">
				<p align="center">	<span style="font-size: 9pt;">책제목</span></p>
			</td>
			<td width="513">
				<p><span style="font-size: 9pt;"> <%=rs.getString("BOOKNAME") %></span></p>
			</td>
		</tr>

		<tr>
			<td width="150" height="23">
				<p align="center">	<span style="font-size: 9pt;">저자명</span></p>
			</td>
			<td width="513">
				<p>
